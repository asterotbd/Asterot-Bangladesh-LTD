...
export const metadata: Metadata = {
  ...
  description: 'Upcoming events from Asterot Bangladesh Limited — tournaments, conferences and programs opening for registration.',
  alternates: {
    canonical: 'https://www.asterot.com/events/upcoming'
  }
}
