        ...
        <RevealSection className="pb-16">
          <div className="flex flex-wrap items-center justify-between gap-6 rounded-[2rem] border border-white/10 bg-black/40 p-8">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/events/past" className="inline-flex items-center justify-center rounded-full bg-primary px-6 py-3 text-sm font-semibold text-black transition hover:bg-accent">
                Past Events
              </Link>
