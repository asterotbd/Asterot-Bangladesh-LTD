      ...
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(255,22,90,0.16),_transparent_26%),linear-gradient(180deg,#050507_0%,#09090f_100%)] py-24">
        ...
        <Container>
          <div className="max-w-3xl space-y-5">
            ...
            <h1 className="fluid-title font-black leading-tight tracking-tight">Upcoming Projects</h1>
            <p className="max-w-[min(65ch,100%)] text-lg leading-8 text-gray-300">List of upcoming projects.</p>
          </div>
        </Container>
      </section>
    </main>
